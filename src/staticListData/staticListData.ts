...
export const staticListData =  {
    getAreaType:(code:string):string=>{
        return areaTypes[code]
    },
    getAreaUtilType:(code:string):string => {
        return areaUtilType[code]
    }
}
const areaUtilType :{[key:string]:string} = {
...
const areaTypes :{[key:string]:string} = {
